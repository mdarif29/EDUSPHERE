...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "c881b6a0-ae93-4540-8492-bf1bedecfed2");
  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            ...
            <ul>
                <li><img src={mail_icon} alt="" />kingarif000@gmail.com</li>
                <li><img src={phone_icon} alt="" />+1 123-456-7890</li>
                <li><img src={location_icon} alt="" />77 Massachuseets Ave, Cambridge <br /> MA 02139, United States</li>
        ...
        <div className="contact-col">
            <form action="" onSubmit={onSubmit}>
                ...
                '6' placeholder='Enter your message' id="" required></textarea>
